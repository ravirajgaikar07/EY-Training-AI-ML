...
def summarizer(paragraph: str) -> str:
    messages = [
        SystemMessage(content="You are a concise summarization assistant."),
        HumanMessage(content=f"Summarize this paragraph in 4–6 bullet points:\n\n{paragraph}")
    ]
...
while True:
    ...
    if "summarize" in user_input.lower():
        try:
            ...
            answer = summarizer(para)
            print("Agent:", answer)
            memory.save_context({"input": para}, {"output": answer})
            continue
